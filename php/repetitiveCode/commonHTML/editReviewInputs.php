<?php
echo '
<input type="hidden" id="currentOverall" value=' . $overall . '>
<input type="hidden" id="currentDifficulty" value=' . $difficulty . '>
<input type="hidden" id="currentAnonymous" value=' . $anonymous . '>
<input type="hidden" id="currentTakeAgain" value=' . $takeAgain . '>
<input type="hidden" id="currentTextbook" value=' . $textbook . '>
<input type="hidden" id="currentGrade" value=' . $grade . '>
<input type="hidden" id="currentYear" value=' . $year . '>
<input type="hidden" id="currentProfessor" value=' . $professor . '>
...
<div class="reviewInputs">
    <form action="review.php" method="POST">
        ...
        <div class="professor">
            ...
            <input type="text" value=' . $professor . ' id="professor" name="professor" maxlength="30" placeholder="(Optional)">
        </div>
